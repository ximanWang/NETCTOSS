        ...
        <div id="main">            
            ...
            <form action="addCost" method="post" class="main_form">
                ...
                <div class="input_info">
                    <input type="text" class="width300" name="cost.cost_name" value="" id="costName" onblur="checkName();"/>
                    <span class="required">*</span>
                    <div class="validate_msg_short" id="costNameMsg">50长度的字母、数字、汉字和下划线的组合</div>
                </div>
                <div class="text_info clearfix"><span>资费类型：</span></div>
                <div class="input_info fee_type">
                    <input type="radio" name="radFeeType" value="0" id="monthly" onclick="feeTypeChange(1);" />
                    <label for="monthly">包月</label>
                    <input type="radio" name="radFeeType" value="1" checked="checked" id="package" onclick="feeTypeChange(2);" />
                    <label for="package">套餐</label>
                    <input type="radio" name="radFeeType" value="2" id="timeBased" onclick="feeTypeChange(3);" />
                    <label for="timeBased">计时</label>
                </div>
                <div class="text_info clearfix"><span>基本时长：</span></div>
                <div class="input_info">
                    <input type="text" name="cost.base_duration" class="width100" />
                ...
                <div class="input_info">
                    <input type="text" name="cost.base_cost" class="width100" />
                ...
                <div class="input_info">
                    <input type="text" name="cost.unit_cost" class="width100" />
