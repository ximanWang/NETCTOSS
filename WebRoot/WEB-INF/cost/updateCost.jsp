    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="updateCost" method="post" class="main_form">
                ...
                <%-- <input type="text" class="readonly" readonly value="<s:property value="cost.id" />" /> --%>
                <s:textfield name="cost.id" cssClass="readonly" readonly="true"></s:textfield>
                </div>
                <div class="text_info clearfix"><span>资费名称：</span></div>
                <div class="input_info">
                   <!-- <input type="text" class="width300" value="<s:property value="cost.cost_name" />"/> --> 
                    <s:textfield name="cost.cost_name" cssClass="width300"></s:textfield>
                ...
                <div class="input_info fee_type">
                    ...
                    <%-- <s:radio name="cost.cost_type" list="#{'1':'包月','2':'套餐','3':'计时' }" onclick="feeTypeChange(this.value);"></s:radio> --%>
                    <s:radio name="cost.cost_type" list="#{'1':'包月','2':'套餐','3':'计时'}" onclick="feeTypeChange(this.value);"></s:radio>
                </div>
                <div class="text_info clearfix"><span>基本时长：</span></div>
                <div class="input_info">
                   <!--  <input type="text" value="" class="width100" /> -->
                    <s:textfield name="cost.base_duration" cssClass="width100"></s:textfield>
                ...
                <div class="input_info">
                    <!-- <input type="text" value="" class="width100" /> -->
                    <s:textfield name="cost.base_cost" cssClass="width100"></s:textfield>
                ...
                <div class="input_info">
                    <!-- <input type="text" value="" class="width100" /> -->
                    <s:textfield name="cost.unit_cost" cssClass="width100"></s:textfield>
